...
func TestContainsInterpolation(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result := interpolation.ContainsInterpolation(tt.input)
...
func TestInterpolateString(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result, err := interpolation.InterpolateString(st, tt.input)
...
func TestInterpolateStringWithContext(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result, err := interpolation.InterpolateStringWithContext(st, tt.input, tt.path)
			if tt.expectErr {
				require.Error(t, err)
			} else {
				require.NoError(t, err)
...
func TestInterpolateValue(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result, err := interpolation.InterpolateValue(tt.input, st, "")
			if tt.expectErr {
				require.Error(t, err)
			} else {
				require.NoError(t, err)
...
func TestInterpolateValueWithContext(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result, err := interpolation.InterpolateValueWithContext(tt.input, st, "")
			if tt.expectErr {
				require.Error(t, err)
			} else {
				require.NoError(t, err)
...
func TestInterpolateStringPermissive(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result, err := interpolation.InterpolateStringPermissive(tt.input, st)
			require.NoError(t, err)
			require.Equal(t, tt.expected, result)
		})
	}
...
func TestInterpolateValuePermissive(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result, err := interpolation.InterpolateValuePermissive(tt.input, st)
			require.NoError(t, err)
			require.Equal(t, tt.expected, result)
		})
	}
